...
export const DataAnaMCQ=[
  {
    ...
    answer: "print()",
    explanation: "In Python, the print() function outputs data to the console. Source: Python.org"
  },
  {
    week: 1,
    topic: "Python Basics",
    ...
    answer: "data_2",
    explanation: "Variable names can include letters, numbers, and underscores but cannot start with a number. Source: Python.org"
  },
  {
    week: 1,
    topic: "NumPy",
    ...
    answer: "np.array()",
    explanation: "np.array() converts lists or tuples into NumPy arrays. Source: NumPy Documentation"
  },
  {
    week: 1,
    topic: "NumPy",
    question: "What does NumPy primarily provide?",
    options: ["Text processing", "2D game design", "Numerical computing", "Web development"],
    answer: "Numerical computing",
    explanation: "NumPy is a core library for numerical and matrix operations in Python. Source: NumPy Documentation"
  },
  {
    week: 1,
    topic: "Pandas",
    ...
    answer: "pd.read_csv()",
    explanation: "pd.read_csv() loads CSV data into a Pandas DataFrame. Source: Pandas Documentation"
  },
  {
    week: 1,
    topic: "Pandas",
    question: "What is a DataFrame in Pandas?",
    options: ["A 3D array", "A tabular data structure", "An image container", "A JSON object"],
    answer: "A tabular data structure",
    explanation: "A DataFrame is a 2D, labeled data structure with rows and columns. Source: Pandas Documentation"
  },
  {
    week: 1,
    ...
    answer: ".ipynb",
    explanation: "Jupyter Notebook files are saved with the .ipynb extension. Source: Jupyter.org"
  },
  {
    week: 1,
    topic: "Jupyter Notebooks",
    ...
    answer: "Shift + Enter",
    explanation: "In Jupyter, Shift + Enter executes the current cell and moves to the next. Source: Jupyter.org"
  },
  {
    week: 1,
    topic: "EDA",
    question: "What does EDA stand for in data analysis?",
    options: ["Extended Data Application", "Exploratory Data Analysis", "Encoded Data Arrangement", "External Data Algorithm"],
    answer: "Exploratory Data Analysis",
    explanation: "EDA is the process of summarizing and visualizing data to uncover patterns. Source: Kaggle Python Course"
  },
  {
    week: 1,
    topic: "EDA",
    question: "Which Pandas function gives quick statistics of numeric columns?",
    options: ["df.info()", "df.describe()", "df.stats()", "df.summary()"],
    answer: "df.describe()",
    explanation: "df.describe() returns count, mean, std, min, max, and quartile values for numerical columns. Source: Pandas Documentation"
  },
  {
    week: 2,
    ...
    answer: "Mean",
    explanation: "Mean changes significantly with outliers. Source: Khan Academy"
  },
  {
    week: 2,
    topic: "Median",
    question: "Median is best described as:",
    options: ["Average of values", "Middle value", "Most frequent value", "Square root of variance"],
    answer: "Middle value",
    explanation: "Median splits the dataset into two equal halves. Source: StatQuest"
  },
  {
    week: 2,
    topic: "Mode",
    question: "Mode represents:",
    options: ["Highest value", "Most common value", "Middle value", "Lowest value"],
    answer: "Most common value",
    explanation: "Mode is the most frequently occurring observation. Source: OpenIntro Stats"
  },
  {
    week: 2,
    topic: "Variance",
    ...
    answer: "Data spread",
    explanation: "Variance quantifies dispersion from the mean. Source: OpenIntro Stats"
  },
  {
    week: 2,
    topic: "Standard Deviation",
    question: "Standard deviation is:",
    options: ["Square root of variance", "Variance squared", "Mean deviation", "Probability sum"],
    answer: "Square root of variance",
    explanation: "It measures average deviation from the mean. Source: Khan Academy"
  },
  {
    week: 2,
    topic: "Bayes Theorem",
    question: "Bayes Theorem is used to:",
    options: ["Find variance", "Update probabilities", "Find mean", "Plot distributions"],
    answer: "Update probabilities",
    explanation: "Bayes Theorem calculates conditional probability. Source: StatQuest"
  },
  {
    week: 2,
    ...
    answer: "Bell-shaped",
    explanation: "Normal distribution is symmetric around the mean. Source: OpenIntro Stats"
  },
  {
    week: 2,
    topic: "Probability",
  ...
  },
  {
    ...
    options: ["All outcomes have equal probability", "Outcomes follow a bell curve", "One outcome dominates", "No probabilities exist"],
    answer: "All outcomes have equal probability",
    explanation: "Uniform means every event is equally likely. Source: OpenIntro Stats"
  },
  {
    week: 2,
    topic: "Z-score",
  ...
  },
  {
    ...
    options: ["Drop rows", "Imputation", "Interpolation", "Model fitting without change"],
    answer: "Model fitting without change",
    explanation: "Models usually need missing values handled first. Source: Scikit-learn Docs"
  },
  {
    week: 3,
    ...
    explanation: "Mean imputation fills missing values with the column mean. Source: Kaggle"
  },
  {
    week: 3,
    topic: "Outliers",
    question: "Boxplots are used to detect:",
    options: ["Scaling issues", "Outliers", "Missing values", "Encoding problems"],
    answer: "Outliers",
    explanation: "Outliers are extreme values outside the whiskers. Source: Medium Tutorials"
  },
  {
    week: 3,
    topic: "IQR",
  ...
  },
  {
    ...
    options: ["Shifts data to mean 0, SD 1", "Removes outliers", "Encodes text", "Drops nulls"],
    answer: "Shifts data to mean 0, SD 1",
    explanation: "Standardization transforms features to standard scale. Source: Scikit-learn Docs"
  },
  {
    week: 3,
    topic: "Normalization",
    ...
    answer: "0 to 1",
    explanation: "Normalization brings all features into the same scale. Source: Medium Tutorials"
  },
  {
    week: 3,
    topic: "Encoding",
    question: "One-hot encoding converts:",
    options: ["Text to lowercase", "Categorical to binary columns", "Numbers to text", "Nulls to mean"],
    answer: "Categorical to binary columns",
    explanation: "Each category becomes its own binary column. Source: Scikit-learn Docs"
  },
  {
    week: 3,
  ...
  },
  {
    ...
    options: ["Training data contains info from test set", "Missing values", "Encoding errors", "Random noise"],
    answer: "Training data contains info from test set",
    explanation: "Leakage leads to overly optimistic results. Source: Medium Tutorials"
  },
  {
    week: 3,
    topic: "Pipeline",
    question: "Pipelines in scikit-learn help:",
    options: ["Automate preprocessing + modeling", "Store datasets", "Create APIs", "Deploy models"],
    answer: "Automate preprocessing + modeling",
    explanation: "Pipelines chain preprocessing and modeling steps. Source: Scikit-learn Docs"
  },
  // Week 4: Data Visualization (10 MCQs)
{
  ...
  answer: 'plt.plot()',
  explanation: 'plt.plot() is the primary function for creating line plots in matplotlib. [Matplotlib Documentation](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.plot.html)'
},
{
  week: 4,
  topic: 'Matplotlib',
  question: 'What does plt.xlabel() do in matplotlib?',
  options: ['Sets the plot title', 'Labels the x-axis', 'Creates a legend', 'Sets axis limits'],
  answer: 'Labels the x-axis',
  explanation: 'plt.xlabel() adds a descriptive label to the x-axis of the plot. [Matplotlib Pyplot Tutorial](https://matplotlib.org/stable/tutorials/introductory/pyplot.html)'
},
{
  week: 4,
  topic: 'Seaborn',
  question: 'Which seaborn function is best for visualizing the distribution of a single variable?',
  options: ['sns.scatterplot()', 'sns.boxplot()', 'sns.histplot()', 'sns.lineplot()'],
  answer: 'sns.histplot()',
  explanation: 'sns.histplot() creates histograms to show the distribution of a single continuous variable. [Seaborn Documentation](https://seaborn.pydata.org/generated/seaborn.histplot.html)'
},
{
  week: 4,
  topic: 'Seaborn',
  question: 'What is the main advantage of seaborn over matplotlib?',
  options: ['Faster performance', 'Better statistical visualizations with less code', 'More color options', 'Smaller file size'],
  answer: 'Better statistical visualizations with less code',
  explanation: 'Seaborn provides high-level statistical visualization functions that require less code than matplotlib. [Seaborn Introduction](https://seaborn.pydata.org/introduction.html)'
},
{
  week: 4,
  topic: 'Plotly',
  question: 'What is the main advantage of Plotly over matplotlib and seaborn?',
  options: ['Better colors', 'Interactive plots', 'Faster rendering', 'Smaller memory usage'],
  answer: 'Interactive plots',
  explanation: 'Plotly creates interactive plots that users can zoom, pan, and hover over for additional information. [Plotly Documentation](https://plotly.com/python/)'
},
{
  week: 4,
  topic: 'Plotly',
  question: 'Which Plotly function is used to create interactive scatter plots?',
  options: ['px.line()', 'px.scatter()', 'px.bar()', 'px.histogram()'],
  answer: 'px.scatter()',
  explanation: 'px.scatter() from plotly.express creates interactive scatter plots with hover information. [Plotly Express Scatter](https://plotly.com/python/line-and-scatter/)'
},
{
  week: 4,
  topic: 'Interactive Dashboards',
  question: 'Which Python library is commonly used for creating web-based data dashboards?',
  options: ['Flask', 'Django', 'Dash', 'FastAPI'],
  answer: 'Dash',
  explanation: 'Dash by Plotly is specifically designed for creating interactive web applications and dashboards for data visualization. [Dash Documentation](https://dash.plotly.com/)'
},
{
  week: 4,
  topic: 'Interactive Dashboards',
  question: 'What is the purpose of callbacks in Dash applications?',
  options: ['To style components', 'To make plots interactive and responsive to user input', 'To load data', 'To save files'],
  answer: 'To make plots interactive and responsive to user input',
  explanation: 'Callbacks in Dash connect user interface components to update plots and components based on user interactions. [Dash Callbacks](https://dash.plotly.com/basic-callbacks)'
},
{
  week: 4,
  topic: 'Data Visualization',
  question: 'Which type of plot is best for showing the relationship between two continuous variables?',
  options: ['Bar chart', 'Histogram', 'Scatter plot', 'Pie chart'],
  answer: 'Scatter plot',
  explanation: 'Scatter plots effectively show relationships, correlations, and patterns between two continuous variables. [Data Visualization Principles](https://serialmentor.com/dataviz/)'
},
{
  week: 4,
  topic: 'Data Visualization',
  question: 'What should you avoid when creating effective data visualizations?',
  options: ['Clear axis labels', 'Appropriate chart types', 'Too many colors and unnecessary 3D effects', 'Consistent scaling'],
  answer: 'Too many colors and unnecessary 3D effects',
  explanation: 'Excessive colors and 3D effects can distract from the data and make visualizations harder to interpret. [Visualization Best Practices](https://www.storytellingwithdata.com/)'
},
...
// Week 5: Exploratory Data Analysis (EDA) (10 MCQs)
{
  ...
  options: ['Multiple variables together', 'One variable at a time', 'Only categorical variables', 'Only numerical variables'],
  answer: 'One variable at a time',
  explanation: 'Univariate analysis focuses on examining the distribution and characteristics of individual variables. [EDA Fundamentals](https://towardsdatascience.com/exploratory-data-analysis-8fc1cb20fd15)'
},
{
  week: 5,
  topic: 'Univariate Analysis',
  ...
  answer: 'Mean',
  explanation: 'The mean is sensitive to extreme values (outliers) as it includes all values in its calculation. [Descriptive Statistics](https://www.khanacademy.org/math/statistics-probability/summarizing-quantitative-data)'
},
{
  week: 5,
  topic: 'Bivariate Plots',
  question: 'Which plot is best for comparing distributions between different categories?',
  options: ['Scatter plot', 'Line plot', 'Box plot', 'Pie chart'],
  answer: 'Box plot',
  explanation: 'Box plots effectively compare distributions across different categories by showing quartiles and outliers. [Seaborn Box Plots](https://seaborn.pydata.org/generated/seaborn.boxplot.html)'
},
{
  week: 5,
  topic: 'Bivariate Plots',
  question: 'What does a heatmap typically show in bivariate analysis?',
  options: ['Individual data points', 'Correlation between variables', 'Time series trends', 'Categorical frequencies'],
  answer: 'Correlation between variables',
  explanation: 'Heatmaps visualize correlation matrices, showing the strength of relationships between pairs of variables. [Correlation Heatmaps](https://seaborn.pydata.org/examples/many_pairwise_correlations.html)'
},
{
  week: 5,
  topic: 'Correlation Analysis',
  question: 'What does a correlation coefficient of -0.85 indicate?',
  options: ['Weak positive correlation', 'Strong positive correlation', 'Strong negative correlation', 'No correlation'],
  answer: 'Strong negative correlation',
  explanation: 'A correlation of -0.85 indicates a strong negative relationship where one variable increases as the other decreases. [Correlation Interpretation](https://www.statisticshowto.com/probability-and-statistics/correlation-coefficient-formula/)'
},
{
  week: 5,
  topic: 'Correlation Analysis',
  question: 'Which pandas function calculates correlation between all numerical columns?',
  options: ['df.describe()', 'df.corr()', 'df.info()', 'df.value_counts()'],
  answer: 'df.corr()',
  explanation: 'df.corr() computes pairwise correlation of columns in a DataFrame, excluding NA/null values. [Pandas Correlation](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.corr.html)'
},
{
  week: 5,
  topic: 'EDA Techniques',
  question: 'What is the primary purpose of checking for missing values in EDA?',
  options: ['To delete the dataset', 'To understand data quality and decide on treatment strategies', 'To increase dataset size', 'To improve visualization colors'],
  answer: 'To understand data quality and decide on treatment strategies',
  explanation: 'Identifying missing values helps assess data quality and determine appropriate handling methods like imputation or removal. [Missing Data Handling](https://towardsdatascience.com/handling-missing-data-for-advanced-machine-learning-4f6c5a15eb6e)'
},
{
  week: 5,
  topic: 'EDA Techniques',
  question: 'Which pandas function provides summary statistics for numerical columns?',
  options: ['df.head()', 'df.info()', 'df.describe()', 'df.shape'],
  answer: 'df.describe()',
  explanation: 'df.describe() generates descriptive statistics including count, mean, std, min, max, and quartiles for numerical columns. [Pandas Describe](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.describe.html)'
},
{
  week: 5,
  topic: 'Data Insights',
  question: 'What should you look for when examining data distributions during EDA?',
  options: ['Only the mean value', 'Skewness, outliers, and distribution shape', 'Only the maximum value', 'Only missing values'],
  answer: 'Skewness, outliers, and distribution shape',
  explanation: 'Understanding distribution characteristics helps in choosing appropriate analysis methods and identifying data anomalies. [Distribution Analysis](https://towardsdatascience.com/understanding-data-distribution-4f84a2e3f6f8)'
},
{
  week: 5,
  topic: 'Data Quality',
  question: 'Why is it important to check for duplicate records during EDA?',
  options: ['To increase dataset size', 'To improve visualization', 'To ensure data accuracy and prevent biased analysis', 'To add more features'],
  answer: 'To ensure data accuracy and prevent biased analysis',
  explanation: 'Duplicate records can skew analysis results and lead to incorrect conclusions by giving extra weight to certain observations. [Data Cleaning Best Practices](https://towardsdatascience.com/the-ultimate-guide-to-data-cleaning-3969843991d4)'
},
...
// Week 6: Supervised Machine Learning (10 MCQs)
{
  week: 6,
  topic: 'Linear Regression',
  question: 'What does linear regression assume about the relationship between variables?',
  options: ['Non-linear relationship', 'Linear relationship', 'No relationship', 'Exponential relationship'],
  answer: 'Linear relationship',
  explanation: 'Linear regression assumes a linear relationship between independent and dependent variables. [Linear Regression Assumptions](https://scikit-learn.org/stable/modules/linear_model.html#ordinary-least-squares)'
},
{
  week: 6,
  topic: 'Linear Regression',
  ...
  explanation: 'MSE measures the average squared difference between actual and predicted values in regression problems. [Regression Metrics](https://scikit-learn.org/stable/modules/model_evaluation.html#regression-metrics)'
},
{
  week: 6,
  topic: 'Decision Trees',
  question: 'What is the main advantage of decision trees?',
  options: ['Always highest accuracy', 'Easy to interpret and visualize', 'Never overfit', 'Fastest training time'],
  answer: 'Easy to interpret and visualize',
  explanation: 'Decision trees provide clear, interpretable rules that can be easily understood and visualized as tree structures. [Decision Trees](https://scikit-learn.org/stable/modules/tree.html)'
},
{
  week: 6,
  topic: 'Decision Trees',
  question: 'What is a common problem with deep decision trees?',
  options: ['Underfitting', 'Overfitting', 'Slow prediction', 'Memory issues'],
  answer: 'Overfitting',
  explanation: 'Deep decision trees can memorize training data, leading to overfitting and poor generalization to new data. [Tree Pruning](https://scikit-learn.org/stable/modules/tree.html#tree-pruning)'
},
{
  week: 6,
  topic: 'Random Forest',
  question: 'How does Random Forest improve upon single decision trees?',
  options: ['Uses only one tree', 'Combines multiple trees to reduce overfitting', 'Is always faster', 'Uses less memory'],
  answer: 'Combines multiple trees to reduce overfitting',
  explanation: 'Random Forest uses ensemble learning with multiple decision trees to improve accuracy and reduce overfitting. [Random Forest](https://scikit-learn.org/stable/modules/ensemble.html#forest)'
},
{
  week: 6,
  topic: 'Random Forest',
  question: 'What does Random Forest use to make final predictions?',
  options: ['The first tree only', 'The most accurate tree', 'Voting/averaging across all trees', 'The last tree only'],
  answer: 'Voting/averaging across all trees',
  explanation: 'Random Forest aggregates predictions from all trees through majority voting (classification) or averaging (regression). [Ensemble Methods](https://scikit-learn.org/stable/modules/ensemble.html)'
},
{
  week: 6,
  topic: 'Model Evaluation',
  question: 'What is the purpose of splitting data into training and testing sets?',
  options: ['To increase dataset size', 'To evaluate model performance on unseen data', 'To improve accuracy', 'To reduce training time'],
  answer: 'To evaluate model performance on unseen data',
  explanation: 'Train-test split allows unbiased evaluation of model performance on data it has not seen during training. [Cross Validation](https://scikit-learn.org/stable/modules/cross_validation.html)'
},
{
  week: 6,
  topic: 'Model Evaluation',
  question: 'What does R-squared measure in regression models?',
  options: ['The number of features', 'The proportion of variance explained by the model', 'The training time', 'The number of data points'],
  answer: 'The proportion of variance explained by the model',
  explanation: 'R-squared indicates how much of the variance in the dependent variable is explained by the independent variables. [R-squared Interpretation](https://scikit-learn.org/stable/modules/model_evaluation.html#r2-score)'
},
{
  week: 6,
  topic: 'Feature Engineering',
  question: 'Why might you need to scale features before applying machine learning algorithms?',
  options: ['To reduce dataset size', 'Because algorithms may be sensitive to feature scales', 'To increase accuracy always', 'To speed up visualization'],
  answer: 'Because algorithms may be sensitive to feature scales',
  explanation: 'Many ML algorithms are sensitive to feature scales, so scaling ensures all features contribute equally to the model. [Feature Scaling](https://scikit-learn.org/stable/modules/preprocessing.html#standardization-or-mean-removal-and-variance-scaling)'
},
{
  week: 6,
  topic: 'Supervised Learning',
  question: 'What is the main difference between classification and regression?',
  options: ['No difference', 'Classification predicts categories, regression predicts continuous values', 'Regression is always more accurate', 'Classification uses more data'],
  answer: 'Classification predicts categories, regression predicts continuous values',
  explanation: 'Classification predicts discrete class labels while regression predicts continuous numerical values. [Supervised Learning Types](https://scikit-learn.org/stable/supervised_learning.html)'
},

{
  ...
  options: ['To classify data into predefined categories', 'To minimize within-cluster sum of squares', 'To maximize between-cluster variance', 'To predict continuous target variables'],
  answer: 'To minimize within-cluster sum of squares',
  explanation: 'K-Means aims to minimize the within-cluster sum of squares (WCSS) by finding optimal cluster centroids. [K-Means Algorithm](https://scikit-learn.org/stable/modules/clustering.html#k-means)'
},
{
  week: 7,
  topic: 'K-Means Clustering',
  question: 'Which parameter in K-Means clustering needs to be specified beforehand?',
  options: ['The distance metric', 'The number of clusters (k)', 'The convergence threshold', 'The initial centroid positions'],
  answer: 'The number of clusters (k)',
  explanation: 'K-Means requires you to specify the number of clusters (k) before running the algorithm. [K-Means Parameters](https://scikit-learn.org/stable/modules/generated/sklearn.cluster.KMeans.html)'
},
{
  week: 7,
  topic: 'PCA',
  question: 'What does PCA stand for and what is its main purpose?',
  options: ['Principal Component Analysis - reduces dimensionality while preserving variance', 'Predictive Classification Algorithm - classifies data points', 'Partial Correlation Analysis - finds relationships', 'Progressive Clustering Approach - groups similar data'],
  answer: 'Principal Component Analysis - reduces dimensionality while preserving variance',
  explanation: 'PCA reduces the number of features while retaining most of the variance in the data through linear transformations. [PCA Documentation](https://scikit-learn.org/stable/modules/decomposition.html#pca)'
},
{
  week: 7,
  topic: 'DBSCAN',
  question: 'Which clustering algorithm can identify clusters of arbitrary shape and handle noise?',
  options: ['K-Means', 'Hierarchical Clustering', 'DBSCAN', 'Gaussian Mixture Models'],
  answer: 'DBSCAN',
  explanation: 'DBSCAN can find clusters of any shape and automatically identifies outliers as noise points. [DBSCAN Algorithm](https://scikit-learn.org/stable/modules/clustering.html#dbscan)'
},
{
  week: 7,
  topic: 'DBSCAN',
  question: 'What are the two main parameters required for DBSCAN?',
  options: ['n_clusters and max_iter', 'eps and min_samples', 'learning_rate and n_estimators', 'alpha and beta'],
  answer: 'eps and min_samples',
  explanation: 'DBSCAN requires eps (maximum distance between two samples) and min_samples (minimum number of samples in a neighborhood). [DBSCAN Parameters](https://scikit-learn.org/stable/modules/generated/sklearn.cluster.DBSCAN.html)'
},
{
  week: 7,
  topic: 'Hierarchical Clustering',
  question: 'What is the output of hierarchical clustering?',
  options: ['A single cluster assignment', 'A dendrogram showing cluster hierarchy', 'Principal components', 'Reduced dimensions'],
  answer: 'A dendrogram showing cluster hierarchy',
  explanation: 'Hierarchical clustering produces a dendrogram that shows the hierarchical relationship between clusters at different levels. [Hierarchical Clustering](https://scikit-learn.org/stable/modules/clustering.html#hierarchical-clustering)'
},
{
  week: 7,
  topic: 'K-Means Clustering',
  question: 'How do you choose the optimal number of clusters in K-Means?',
  options: ['Always use 3 clusters', 'Use the elbow method', 'Use the maximum possible clusters', 'Use the minimum possible clusters'],
  answer: 'Use the elbow method',
  explanation: 'The elbow method plots WCSS vs number of clusters and looks for the "elbow" point where improvement diminishes. [Elbow Method](https://scikit-learn.org/stable/auto_examples/cluster/plot_kmeans_digits.html)'
},
{
  week: 7,
  topic: 'PCA',
  question: 'What does the first principal component represent?',
  options: ['The least important feature', 'The direction of maximum variance', 'The original first column', 'The cluster center'],
  answer: 'The direction of maximum variance',
  explanation: 'The first principal component captures the direction in which the data varies the most. [PCA Components](https://scikit-learn.org/stable/modules/decomposition.html#principal-component-analysis-pca)'
},
{
  week: 7,
  topic: 'Unsupervised Learning',
  question: 'What is the main difference between supervised and unsupervised learning?',
  options: ['Supervised uses more data', 'Unsupervised has no target variable', 'Supervised is always more accurate', 'No difference'],
  answer: 'Unsupervised has no target variable',
  explanation: 'Unsupervised learning finds patterns in data without labeled target variables, unlike supervised learning. [Unsupervised Learning](https://scikit-learn.org/stable/unsupervised_learning.html)'
},
{
  week: 7,
  topic: 'Hierarchical Clustering',
  question: 'What are the two main types of hierarchical clustering?',
  options: ['K-means and DBSCAN', 'Agglomerative and Divisive', 'Supervised and Unsupervised', 'Linear and Non-linear'],
  answer: 'Agglomerative and Divisive',
  explanation: 'Agglomerative starts with individual points and merges clusters, while divisive starts with all points and splits clusters. [Hierarchical Types](https://scikit-learn.org/stable/modules/clustering.html#hierarchical-clustering)'
},
{
  week: 8,
  topic: 'Moving Averages',
  question: 'What is the purpose of a moving average in time series analysis?',
  options: ['To increase data points', 'To smooth out short-term fluctuations', 'To add seasonality', 'To create missing values'],
  answer: 'To smooth out short-term fluctuations',
  explanation: 'Moving averages smooth time series data by averaging values over a sliding window to reveal underlying trends. [Moving Averages](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.rolling.html)'
},
{
  week: 8,
  topic: 'ARIMA',
  question: 'What do the three parameters (p, d, q) in ARIMA represent?',
  options: ['Past, Data, Quality', 'Autoregressive order, Differencing degree, Moving average order', 'Prediction, Drift, Quantity', 'Period, Duration, Quality'],
  answer: 'Autoregressive order, Differencing degree, Moving average order',
  explanation: 'ARIMA(p,d,q): p is autoregressive terms, d is degree of differencing, q is moving average terms. [ARIMA Model](https://www.statsmodels.org/stable/generated/statsmodels.tsa.arima.model.ARIMA.html)'
},
{
  week: 8,
  topic: 'Seasonality',
  question: 'What is seasonality in time series data?',
  options: ['Random fluctuations', 'Predictable patterns that repeat over fixed periods', 'Linear trends', 'Missing data points'],
  answer: 'Predictable patterns that repeat over fixed periods',
  explanation: 'Seasonality refers to regular, predictable patterns that repeat over specific time periods like months or quarters. [Time Series Components](https://www.statsmodels.org/stable/tsa.html#time-series-analysis)'
},
{
  week: 8,
  topic: 'Forecasting',
  question: 'What is the main goal of time series forecasting?',
  options: ['To explain past events', 'To predict future values based on historical patterns', 'To remove outliers', 'To visualize data'],
  answer: 'To predict future values based on historical patterns',
  explanation: 'Time series forecasting uses historical data patterns to predict future values of the time series. [Forecasting Methods](https://www.statsmodels.org/stable/tsa.html#forecasting)'
},
{
  week: 8,
  topic: 'Time Series',
  question: 'What makes time series data different from regular datasets?',
  options: ['It has more columns', 'It has temporal ordering and autocorrelation', 'It has fewer rows', 'It has no missing values'],
  answer: 'It has temporal ordering and autocorrelation',
  explanation: 'Time series data has temporal dependencies where current values depend on past values (autocorrelation). [Time Series Properties](https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html)'
},
{
  week: 8,
  topic: 'ARIMA',
  question: 'What does stationarity mean in time series analysis?',
  options: ['Data never changes', 'Statistical properties remain constant over time', 'Data has no trend', 'Data has perfect correlation'],
  answer: 'Statistical properties remain constant over time',
  explanation: 'Stationarity means the mean, variance, and autocorrelation structure do not change over time. [Stationarity](https://www.statsmodels.org/stable/tsa.html#stationary-and-non-stationary-time-series)'
},
{
  week: 8,
  topic: 'Moving Averages',
  question: 'What is the difference between simple and exponential moving averages?',
  options: ['No difference', 'Exponential gives more weight to recent observations', 'Simple is always better', 'Exponential uses fewer data points'],
  answer: 'Exponential gives more weight to recent observations',
  explanation: 'Exponential moving averages assign exponentially decreasing weights to older observations, making them more responsive to recent changes. [EMA vs SMA](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.ewm.html)'
},
{
  week: 8,
  topic: 'Time Series',
  question: 'What are the main components of a time series?',
  options: ['Mean and variance only', 'Trend, Seasonality, and Residual', 'Only trend', 'Only seasonality'],
  answer: 'Trend, Seasonality, and Residual',
  explanation: 'Time series can be decomposed into trend (long-term direction), seasonality (recurring patterns), and residual (random component). [Time Series Decomposition](https://www.statsmodels.org/stable/generated/statsmodels.tsa.seasonal.seasonal_decompose.html)'
},
{
  week: 8,
  topic: 'Forecasting',
  question: 'Which metric is commonly used to evaluate time series forecasting accuracy?',
  options: ['Accuracy', 'F1-score', 'Mean Absolute Error (MAE)', 'Confusion Matrix'],
  answer: 'Mean Absolute Error (MAE)',
  explanation: 'MAE measures the average absolute difference between actual and predicted values, making it suitable for regression-type forecasting problems. [Forecasting Metrics](https://scikit-learn.org/stable/modules/model_evaluation.html#regression-metrics)'
},
{
  week: 8,
  topic: 'Time Series',
  question: 'What is autocorrelation in time series?',
  options: ['Correlation between different variables', 'Correlation of a series with its own lagged values', 'Perfect correlation', 'No correlation'],
  answer: 'Correlation of a series with its own lagged values',
  explanation: 'Autocorrelation measures how current values in a time series correlate with past values at different time lags. [Autocorrelation](https://www.statsmodels.org/stable/generated/statsmodels.tsa.stattools.acf.html)'
},
{
  week: 9,
  topic: 'Tokenization',
  question: 'What is tokenization in NLP?',
  options: ['Encrypting text data', 'Breaking text into individual words or tokens', 'Translating languages', 'Removing punctuation'],
  answer: 'Breaking text into individual words or tokens',
  explanation: 'Tokenization splits text into smaller units (tokens) like words, phrases, or sentences for further processing. [NLTK Tokenization](https://www.nltk.org/api/nltk.tokenize.html)'
},
{
  week: 9,
  topic: 'TF-IDF',
  question: 'What does TF-IDF stand for and measure?',
  options: ['Text Frequency - Inverse Document Frequency; measures word importance', 'Term Frequency - Inverse Document Frequency; measures word importance', 'Total Features - Inverse Data Frequency; measures features', 'Text Features - Internal Data Frequency; measures text'],
  answer: 'Term Frequency - Inverse Document Frequency; measures word importance',
  explanation: 'TF-IDF measures how important a word is to a document relative to a collection of documents. [TF-IDF Vectorizer](https://scikit-learn.org/stable/modules/generated/sklearn.feature_extraction.text.TfidfVectorizer.html)'
},
{
  week: 9,
  topic: 'Text Classification',
  question: 'What is the goal of text classification?',
  options: ['To count words', 'To assign predefined categories to text documents', 'To translate text', 'To generate new text'],
  answer: 'To assign predefined categories to text documents',
  explanation: 'Text classification automatically assigns text documents to predefined categories based on their content. [Text Classification](https://scikit-learn.org/stable/tutorial/text_analytics/working_with_text_data.html)'
},
{
  week: 9,
  ...
  answer: 'Naive Bayes',
  explanation: 'Naive Bayes is particularly effective for text classification due to its handling of high-dimensional sparse data. [Naive Bayes Text](https://scikit-learn.org/stable/modules/naive_bayes.html#multinomial-naive-bayes)'
},
{
  week: 9,
  topic: 'Text Preprocessing',
  question: 'What is the purpose of removing stop words in text preprocessing?',
  options: ['To increase text length', 'To remove common words that carry little meaningful information', 'To add punctuation', 'To translate text'],
  answer: 'To remove common words that carry little meaningful information',
  explanation: 'Stop words like "the", "and", "is" are removed because they appear frequently but carry little discriminative information. [Stop Words](https://www.nltk.org/book/ch02.html)'
},
{
  week: 9,
  topic: 'TF-IDF',
  question: 'How does TF-IDF handle words that appear in many documents?',
  options: ['Increases their weight', 'Decreases their weight', 'Keeps weight the same', 'Removes them completely'],
  answer: 'Decreases their weight',
  explanation: 'TF-IDF reduces the weight of words that appear frequently across many documents since they are less discriminative. [TF-IDF Formula](https://scikit-learn.org/stable/modules/feature_extraction.html#tfidf-term-weighting)'
},
{
  week: 9,
  topic: 'Text Classification',
  question: 'What type of data do you need for supervised text classification?',
  options: ['Only text documents', 'Text documents with known category labels', 'Only category labels', 'Unlabeled text only'],
  answer: 'Text documents with known category labels',
  explanation: 'Supervised text classification requires labeled training data with both text documents and their corresponding categories. [Supervised Learning](https://scikit-learn.org/stable/supervised_learning.html)'
},
{
  week: 9,
  topic: 'Basic NLP Models',
  question: 'What is a bag-of-words model?',
  options: ['A model that considers word order', 'A model that represents text as a collection of words ignoring order', 'A model for generating text', 'A model for word translation'],
  answer: 'A model that represents text as a collection of words ignoring order',
  explanation: 'Bag-of-words represents text as an unordered collection of words, focusing on word frequency rather than sequence. [Bag of Words](https://scikit-learn.org/stable/modules/feature_extraction.html#the-bag-of-words-representation)'
},
{
  week: 9,
  topic: 'Tokenization',
  question: 'What is the difference between word tokenization and sentence tokenization?',
  options: ['No difference', 'Word splits text into words, sentence splits into sentences', 'Word is faster', 'Sentence is more accurate'],
  answer: 'Word splits text into words, sentence splits into sentences',
  explanation: 'Word tokenization breaks text into individual words while sentence tokenization splits text into individual sentences. [NLTK Tokenizers](https://www.nltk.org/api/nltk.tokenize.html)'
},
{
  week: 9,
  topic: 'Text Classification',
  question: 'Which evaluation metric is appropriate for multi-class text classification?',
  options: ['Mean Squared Error', 'R-squared', 'Accuracy and F1-score', 'Silhouette score'],
  answer: 'Accuracy and F1-score',
  explanation: 'Classification metrics like accuracy, precision, recall, and F1-score are used to evaluate text classification performance. [Classification Metrics](https://scikit-learn.org/stable/modules/model_evaluation.html#classification-metrics)'
},
{
  week: 10,
  topic: 'Data Pipeline',
  question: 'What is a data pipeline in the context of a data science project?',
  options: ['A physical pipe for data', 'A series of automated steps for processing data from source to destination', 'A visualization tool', 'A storage system'],
  answer: 'A series of automated steps for processing data from source to destination',
  explanation: 'A data pipeline automates the flow and transformation of data through various processing stages in a systematic way. [Data Pipelines](https://scikit-learn.org/stable/modules/compose.html#pipeline)'
},
{
  week: 10,
  topic: 'Model Building',
  question: 'What should you do before deploying a machine learning model?',
  options: ['Deploy immediately', 'Validate performance on test data and ensure reproducibility', 'Use only training data', 'Skip testing'],
  answer: 'Validate performance on test data and ensure reproducibility',
  explanation: 'Model validation ensures the model performs well on unseen data and deployment processes are reproducible. [Model Selection](https://scikit-learn.org/stable/model_selection.html)'
},
{
  week: 10,
  topic: 'Flask App',
  question: 'What is Flask in the context of model deployment?',
  options: ['A database', 'A lightweight web framework for creating web applications', 'A machine learning library', 'A visualization tool'],
  answer: 'A lightweight web framework for creating web applications',
  explanation: 'Flask is a Python web framework that allows you to create web applications and APIs for deploying ML models. [Flask Documentation](https://flask.palletsprojects.com/)'
},
{
  week: 10,
  topic: 'Streamlit App',
  question: 'What is the main advantage of using Streamlit for data science projects?',
  options: ['It is the fastest framework', 'It allows rapid creation of interactive web apps with minimal code', 'It has the best graphics', 'It uses the least memory'],
  answer: 'It allows rapid creation of interactive web apps with minimal code',
  explanation: 'Streamlit enables data scientists to quickly create interactive web applications without extensive web development knowledge. [Streamlit Docs](https://docs.streamlit.io/)'
},
{
  week: 10,
  topic: 'GitHub Hosting',
  question: 'Why is version control important in data science projects?',
  options: ['It makes code faster', 'It tracks changes, enables collaboration, and maintains project history', 'It reduces file size', 'It improves accuracy'],
  answer: 'It tracks changes, enables collaboration, and maintains project history',
  explanation: 'Version control systems like Git help manage code changes, facilitate team collaboration, and maintain a complete project history. [Git for Data Science](https://git-scm.com/doc)'
},
{
  week: 10,
  topic: 'Model Deployment',
  question: 'What is the difference between model training and model deployment?',
  options: ['No difference', 'Training builds the model, deployment makes it available for use', 'Training is faster', 'Deployment uses less data'],
  answer: 'Training builds the model, deployment makes it available for use',
  explanation: 'Training creates and optimizes the model using historical data, while deployment makes the trained model accessible for real-world predictions. [MLOps](https://ml-ops.org/)'
},
{
  week: 10,
  topic: 'Data Pipeline',
  question: 'What are the typical stages in a data science pipeline?',
  options: ['Only data collection', 'Data collection, preprocessing, modeling, evaluation, deployment', 'Only modeling', 'Only visualization'],
  answer: 'Data collection, preprocessing, modeling, evaluation, deployment',
  explanation: 'A complete data science pipeline includes data collection, cleaning/preprocessing, model training, evaluation, and deployment stages. [ML Pipeline](https://scikit-learn.org/stable/modules/compose.html#pipeline)'
},
{
  week: 10,
  topic: 'Dashboard',
  question: 'What is the purpose of creating a dashboard for a data science project?',
  options: ['To slow down the project', 'To provide interactive visualization and insights for stakeholders', 'To increase complexity', 'To hide results'],
  answer: 'To provide interactive visualization and insights for stakeholders',
  explanation: 'Dashboards present data insights and model results in an accessible, interactive format for business users and stakeholders. [Dashboard Design](https://plotly.com/dash/)'
},
{
  week: 10,
  topic: 'Model Building',
  question: 'What is cross-validation and why is it important?',
  options: ['A type of model', 'A technique to assess model performance and generalization', 'A deployment method', 'A data collection technique'],
  answer: 'A technique to assess model performance and generalization',
  explanation: 'Cross-validation evaluates model performance across multiple train-test splits to get a more reliable estimate of generalization. [Cross Validation](https://scikit-learn.org/stable/modules/cross_validation.html)'
},
{
  week: 10,
  topic: 'Capstone Project',
  question: 'What makes a good capstone data science project?',
  options: ['Uses the most complex algorithms', 'Addresses a real problem, demonstrates technical skills, and provides actionable insights', 'Has the most features', 'Takes the longest time'],
  answer: 'Addresses a real problem, demonstrates technical skills, and provides actionable insights',
  explanation: 'A strong capstone project combines technical proficiency with practical problem-solving and clear communication of results. [Project Portfolio](https://towardsdatascience.com/how-to-build-a-data-science-portfolio-5f566517c79c)'
}
